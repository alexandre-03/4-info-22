...
<html lang="pt">
  <head>
    ...
    <title>Saudades, Bazuca</title>	
  </head>
  <body>
  <header class="d-flex">
	<div class="container align-items-center">	
		<h1> Kauã Alexandre - IPW 4 Mendes </h1>
		</div>
	</header>
  ...
  <section class="container">
	...
	<h3 class="p-2"> 3_array</h3>
				<ul>	
					...
					<li>
						<a href="?dir=3_array&file=exercicio01">01</a>
					</li>
					
					<li>
						<a href="?dir=3_array&file=02">02</a>
					</li>
					<li>
	...
	<footer>
		<div class="container row">
			Copyright <?php echo date ('y'); ?> - TI Mendes em memória de: Bazuca
		</div>
	</footer>
